...
4. Check `For-Agent/Docs/artifacts.md` when research, review, or task-report artifacts were created or reused.
...
8. Check that changed logic and high-risk contracts have suitable tests under `For-Agent/Docs/testing.md`.
9. Confirm affected `For-Agent/Docs/` guidance was updated, or record that documentation review found no required update.
10. Determine applicable build and test verification from `For-Agent/Docs/build.md`; use `cmake-build-debug` for the documented commands.
