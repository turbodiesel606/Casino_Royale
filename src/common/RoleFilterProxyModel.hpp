#ifndef JOBTRACKER_SRC_COMMON_ROLEFILTERPROXYMODEL_HPP
#define JOBTRACKER_SRC_COMMON_ROLEFILTERPROXYMODEL_HPP
...
#endif // JOBTRACKER_SRC_COMMON_ROLEFILTERPROXYMODEL_HPP
