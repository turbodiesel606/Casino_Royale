...
void initializeVersionFour(QSqlDatabase& database)
{
    sql::execute(database, QStringLiteral(
        ...
        QStringLiteral("create schema v4 CV table"));
    ...
    sql::execute(database, QStringLiteral(
        ...
        "created_at TEXT NOT NULL,"
        "updated_at TEXT NOT NULL)"),
        QStringLiteral("create schema v4 companies table"));
    ...
    sql::execute(database, QStringLiteral(
        ...
        QStringLiteral("create schema v4 jobs table"));
    ...
    sql::execute(database, QStringLiteral(
        ...
        QStringLiteral("create schema v4 job technologies table"));

    sql::execute(
        database,
        QStringLiteral("PRAGMA user_version = 4"),
        QStringLiteral("record schema version 4 initialization"));
}
