#ifndef JOBTRACKER_SRC_DIRECTORY_LINKEDCOMPANYCONTACTSMODEL_HPP
#define JOBTRACKER_SRC_DIRECTORY_LINKEDCOMPANYCONTACTSMODEL_HPP
...
#endif // JOBTRACKER_SRC_DIRECTORY_LINKEDCOMPANYCONTACTSMODEL_HPP
